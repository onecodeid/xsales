...
SET L_InvoiceTotal = b_total, L_InvoicePPN = b_ppn, 
...
CALL sp_journal_save_notrans(journal_id, invoice_date, invoice_number, invoice_note, adata, "J.YY", account_revenue_id );
