...
IFNULL(M_CustomerPhones, "[]") customer_phones,
    ...
    CONCAT("[", GROUP_CONCAT(
        ...
        "item_ppn", L_SalesDetailPPN, "item_subtotal", L_SalesDetailSubTotal, "item_total", L_SalesDetailTotal,
        "item_retur_qty", L_SalesDetailReturQty, "item_retur_nominal", L_SalesDetailReturNominal)), "]") items,
    banks,
    fn_terbilang(L_SalesGrandTotal) terbilang,
    fn_terbilang(L_SalesRetur) retur_terbilang,
