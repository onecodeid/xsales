...
class Accountreport extends MY_Controller
{
    function __construct()
    {
        ...
        $this->load->model('master/m_accountreport');
    }

    function search_group()
    {
        $r = $this->m_accountreport->search_group();
        $this->sys_ok($r);
    }

    function search()
    {
        $r = $this->m_accountreport->search2(
            ['group'=>$this->sys_input['group']]);
        $this->sys_ok($r);
    }
    ...
    function save()
    {
        ...
        $r = $this->m_accountreport->save( $this->sys_input );
