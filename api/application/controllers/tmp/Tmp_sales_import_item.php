...
class Tmp_sales_import_item extends MY_Controller
{
    function __construct()
    {
        parent::__construct();

        $this->load->model('tmp/m_tmp_sales_import_item');
    }

    function search()
    {
        $r = $this->m_tmp_sales_import_item->search([
    ...
    //     if (isset($this->sys_input['expedition_id']))
        $r = $this->m_tmp_sales_import_item->save( $this->sys_input );
    //     else
