...
class One_sales_016 extends RPT_Controller
{
    var $report_code;
    var $wQty;
    ...
    function search()
    {
        ...
        $r = $this->r_reportsales->sales_016($prm);
        $this->sys_ok($r);
    }
    ...
    function excel()
    {
        ...
        $filename = "laporan_penjualan_pelanggan_baru_".date('d.m.Y', strtotime($this->input->get('sdate')))."_".date('d.m.Y', strtotime($this->input->get('edate'))).".xls";
        ...
        if ($r)
        {
            ...
            $objPHPExcel = $objReader->load("./assets/template_sales_016.xls");
            ...
            foreach ($r['records'] as $k => $v)
            {
                ...
                $as->mergeCells("D{$myLine}:M{$myLine}");
