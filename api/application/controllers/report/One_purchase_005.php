...
class One_purchase_005 extends RPT_Controller
{
    var $report_code;
    var $wQty;
    ...
    function search()
    {
        ...
        $r = $this->r_reportpurchase->purchase_005($prm);
        $this->sys_ok($r);
    }
    ...
    function excel()
    {
        ...
        $filename = "laporan_pembelian_per_produk_".date('d.m.Y', strtotime($this->input->get('sdate')))."_".date('d.m.Y', strtotime($this->input->get('edate'))).".xls";
        ...
        if ($r)
        {
            ...
            $objPHPExcel = $objReader->load("./assets/template_purchase_005.xls");
