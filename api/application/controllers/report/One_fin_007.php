...
class One_fin_007 extends RPT_Controller
{
    ...
    function index() {
        ...
        $r = $this->r_report->one_fin_007( isset($this->sys_input['customerid'])?$this->sys_input['customerid']:0 );
    ...
    static function my_header_recapt($me)
    {
        ...
        $me->pdf->SetFont('Arial','B', 9);
        $me->pdf->Cell(1, 0.7, "NO" , 'TLBR', 0, 'C', 1);
        $me->pdf->Cell(4, 0.7, "KETERANGAN" , 'TBLR', 0, 'C', 1);
        $me->pdf->Cell($w - 21.5, 0.7, "NOMOR INVOICE" , 'TLBR', 0, 'C', 1);
        $me->pdf->Cell(3, 0.7, "TANGGAL" , 'TBLR', 0, 'C', 1);
        $me->pdf->Cell(3, 0.7, "JATUH TEMPO" , 'TBLR', 0, 'C', 1);
        $me->pdf->Cell(1, 0.7, "TERM" , 'TLBR', 0, 'C', 1);
        $me->pdf->Cell(3.5, 0.7, "JUMLAH" , 'TBLR', 0, 'C', 1);
        $me->pdf->Cell(2.5, 0.7, "POTONGAN" , 'TLBR', 0, 'C', 1);
        $me->pdf->Cell(3.5, 0.7, "SISA PIUTANG" , 'TLBR', 0, 'C', 1);
        $me->pdf->Ln(0.8);
