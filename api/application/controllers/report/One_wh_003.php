...
class One_wh_003 extends RPT_Controller
{
    var $report_code;
    ...
    function index() {
        ...
        $r = $this->r_report->one_wh_003( $this->input->get('sdate'), $this->input->get('edate'), $this->input->get('exp_id') );
        // print_r($r);
        //
        $grand_total = 0;
        $sub_total = 0;
        ...
        if ($r)
        {
            ...
            $this->my_header($this, 
                'REKAP LOGBOOK EKSPEDISI GUDANG ZALFA', 
            ...
            foreach ($data as $k => $v)
            {
                ...
                $this->pdf->Cell(4.5, $d, $v['packing_username'], 'LBR', 0, 'L', 1);
                $this->pdf->Ln($d);
...
//   }
    ...
    function tableHeader($me)
    {
        ...
        $me->Cell(4.5, 1, 'USER PACKING' , 'LTBR', 0, 'C', 1);
