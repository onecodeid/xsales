...
class One_iv_012 extends RPT_Controller
{
    ...
    function search()
    {
        ...
        $r = $this->r_reportinventory->iv_012($prm);
        $this->sys_ok($r);
    }
    ...
    function save_analytic() {
        ...
        $d = $this->sys_input;
        $r = $this->an_misc->save_by_code('RPT.IV012', $d);
        $this->sys_ok($r);
    }
