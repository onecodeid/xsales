SELECT t_journalid journal_id, t_journaldate jdate, t_journalnumber jnumber,
    t_journalcashflow flow_code, t_journaldetailcredit jcredit, T_journalDetailDebit jdebit,
    ifnull(t_journaldetailledgernote, '') jnote, m_accountname account_name
