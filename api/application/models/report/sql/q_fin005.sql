...
select a.m_accountid account_id, 
IFNULL(b.m_accountcode, a.m_accountcode) account_code, IFNULL(b.m_accountname, a.m_accountname) account_name,
...
left join t_balance on t_balancem_accountid = a.m_accountid and t_balanceisactive = "Y" and t_balanceyear = year(?)
