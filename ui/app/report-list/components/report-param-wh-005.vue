...
module.exports = {
    ...
    computed : {
        dialog : {
            get () { return this.$store.state.report_param.dialog['wh-005'] },
            set (v) { this.$store.commit('report_param/set_dialog', ['wh-005', v]) }
        },
        ...
        params () {
            return ['sdate='+this.sdate, 'edate='+this.edate, 'item_id='+(this.selected_item?this.selected_item.M_ItemID:0)].join('&')
        },
