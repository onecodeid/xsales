...
module.exports = {
    ...
    computed : {
        dialog : {
            get () { return this.$store.state.report_param.dialog['sales-012'] },
            set (v) { this.$store.commit('report_param/set_dialog', ['sales-012', v]) }
        },
        ...
        params () {
            return ['sdate='+this.sdate, 'edate='+this.edate, 'staffid='+this.selected_staff.staff_id, '', 'iscompany='+this.selected_b2b.id].join('&')
        },
        ...
        b2bs () {
            return this.$store.state.report_param.customer_b2bs
        },

        selected_b2b : {
            get () { return this.$store.state.report_param.selected_customer_b2b },
            set (v) { this.$store.commit('report_param/set_selected_customer_b2b', v) }
        }
    },
