...
module.exports = {
    ...
    computed : {
        dialog : {
            get () { return this.$store.state.report_param.dialog['fin-001'] },
            set (v) { this.$store.commit('report_param/set_dialog', ['fin-001', v]) }
        },
        ...
        selected_account : {
            ...
            set (v) { this.$store.commit('report_param/set_selected_account', v) }
        }
    },
