        ...
        <v-card-text primary-title class="pt-2 pb-0">
            <v-layout row wrap>
                <v-flex xs12>
                    <v-layout row wrap>
                        <v-flex xs5>
                            <h3 class="display-1 font-weight-light zalfa-text-title">MTD PROJO</h3>       
                        </v-flex>
                        <v-flex xs3>
                            &nbsp;
                        </v-flex>
                ...
                <v-flex xs12>
                    ...
                    >
                        ...
                        <tr :active="props.selected" @click="props.selected = !props.selected">
                            <td class="text-xs-left px-2">{{ props.item.staff_name }}</td>
                            <td class="text-xs-right px-2">{{ one_money(props.item.target) }}</td>
                            <td class="text-xs-right px-2">{{ one_money(props.item.mtd_1st) }}</td>
