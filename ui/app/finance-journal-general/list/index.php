         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <!-- <common-notification></common-notification> -->
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <finance-journal-general-list></finance-journal-general-list>
...
mounted: function() {
   ...
   this.$store.dispatch('general/search').then(resx => {})
},
computed : {
    one_token () {
...
methods : {
   ...
   components: {
        ...
        "finance-journal-general-list" : httpVueLoader("../components/finance-journal-general-list.vue<?= $ts; ?>"),
