...
module.exports = {
    ...
    computed : {
        ...
        sales_franco : {
            get () { return this.$store.state.sales_new.sales_franco },
            set (v) { this.$store.commit('sales_new/set_common', ['sales_franco', v]) }
        },

        sales_delivery : {
            get () { return this.$store.state.sales_new.sales_delivery },
            set (v) { this.$store.commit('sales_new/set_common', ['sales_delivery', v]) }
        },

        sales_validity : {
            get () { return this.$store.state.sales_new.sales_validity },
            set (v) { this.$store.commit('sales_new/set_common', ['sales_validity', v]) }
        },

        sales_used () {
            return this.$store.state.sales_new.sales_used
        },
        ...
        units () {
            return this.$store.state.sales_new.units
        },

        packs () {
            return this.$store.state.sales_new.packs
        },
        ...
        selected_customer : {
            ...
            set (v) { this.$store.commit('sales_new/set_selected_customer', v) }
        },
        ...
        selected_staff : {
            ...
            set (v) { this.$store.commit('sales_new/set_selected_staff', v) }
        },
        ...
        selected_leadtype : {
            get () { return this.$store.state.sales_new.selected_leadtype },
            set (v) { this.$store.commit('sales_new/set_selected_leadtype', v) }
        }
    },
    ...
    mounted () {
        ...
        this.$store.dispatch('sales_new/search_pack')
        this.$store.dispatch('sales_new/search_unit')
    },
