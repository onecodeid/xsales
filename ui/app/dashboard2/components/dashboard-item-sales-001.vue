        ...
        <v-card-text class="pa-0">
            <v-layout row wrap>
                <v-flex xs3 class="text-xs-center" py-3 px-1>
                    ...
                    <v-layout row wrap>
                        ...
                        <v-flex xs12 class="caption">
                            <v-divider class="my-1"></v-divider>
                            <v-layout row wrap>
                                <v-flex><span class="blue py-1 pl-2 pr-1 white--text d-block">Targets</span></v-flex>
                ...
                <v-flex xs9 py-2 px-1>
                    ...
                    <!-- <object :data="'./components/snippet.php?data='+JSON.stringify(sales001.omzets)" width="100%" height="100%"></object> -->
                </v-flex>
            </v-layout>
        </v-card-text>
    </v-card>
