...
export default {
    ...
    actions: {
        async searchWarehouse001(context) {
            let prm = {
                search: context.state.search,
                edate: context.state.edate, //current_date,
                sdate: context.state.sdate, //first_date,
                staff_id: context.state.selected_staff?context.state.selected_staff.staff_id:0
            }

            return context.dispatch("system/postme", {
                url: "dashboard/dashboard_warehouse/warehouse001",
                prm: prm,
                callback: function(d) {
                    d.state = true
                    context.commit('set_object', ['warehouse001', d])
                    return d
                }
            }, { root: true })
        },

        async searchWarehouse002(context) {
            let prm = {
                search: "",
                edate: context.state.edate, //current_date,
                sdate: context.state.sdate, //first_date,
            ...
            return context.dispatch("system/postme", {
                url: "dashboard/dashboard_warehouse/warehouse002",
                prm: prm,
                callback: function(d) {
                    context.commit('set_object', ['warehouse002', d])
                    return d
                }
            }, { root: true })
        },

        async searchWarehouse003(context) {
            let prm = {
                search: "",
                edate: context.state.edate, //current_date,
                sdate: context.state.sdate, //first_date,
            ...
            return context.dispatch("system/postme", {
                url: "dashboard/dashboard_warehouse/warehouse003",
                prm: prm,
                callback: function(d) {
                    context.commit('set_object', ['warehouse003', d])
                    return d
                }
            }, { root: true })
        },
