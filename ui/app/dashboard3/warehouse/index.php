...
methods : {
   ...
   components: {
        ...
        "dashboard-warehouse" : httpVueLoader("../components/dashboard-warehouse.vue<?php echo $ts ?>"),
        "dashboard-admin" : httpVueLoader("../components/dashboard-admin.vue<?php echo $ts ?>")
      }
    })
    </script>
    <style>
