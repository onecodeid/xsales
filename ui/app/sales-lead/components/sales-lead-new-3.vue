                                                    ...
                                                    <v-flex xs4>
                                                        <v-layout row wrap>
                                                            ...
                                                            <template v-for="x in 2">
                                                                <v-flex xs4 :key="x" class="subheading text-xs-right cyan py-2 px-3 white--text rotate-90">
                                                                    {{categories[x-1].category_name}}</v-flex>
                                                            </template>
                                                        </v-layout>
                                                    </v-flex>
                                                    <v-flex xs8>
                                                        <v-layout row wrap>
                                                            <template v-for="x in 8">
                                                                <v-flex xs2 :key="x" v-if="x>2" class="subheading text-xs-right cyan py-2 px-3 white--text rotate-90">
                                                                    {{categories[x-1].category_name}}</v-flex>
                                                            </template>
                                                            <!-- <v-flex xs2>&nbsp;</v-flex> -->
                                                        </v-layout>
