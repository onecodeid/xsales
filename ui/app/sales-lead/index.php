...
methods : {
   ...
   components: {
        ...
        "sales-lead-list" : httpVueLoader("./components/sales-lead-list-2.vue?t=<?=date('YmdHis');?>"),
        "sales-lead-new" : httpVueLoader("./components/sales-lead-new-2.vue?t=<?=date('YmdHis');?>")
      }
    })
    </script>
    <style>
