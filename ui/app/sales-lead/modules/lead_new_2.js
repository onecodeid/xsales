...
export default {
    ...
    actions: {
        ...
        async search_leadcategory(context) {
            let prm = {
                search: context.state.search,
                page: 1
            }
            ...
            context.dispatch("system/postme", {
                url: "master/leadcategory/search_dd",
                prm: prm,
                callback: function(d) {
                    context.commit("set_object", ['leadcategories', d.records])
                    ...
                    for (let i in leads) {
                        ...
                        for (let ctg of context.state.leadcategories)
                            values['Cx' + ctg.category_id] = { b2b: 0, b2c: 0, total: 0 }
        ...
        async search_prospect(context) {
            ...
            context.dispatch("system/postme", {
                ...
                callback: function(d) {
                    ...
                    context.dispatch("search_leadcategory")
