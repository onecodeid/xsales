<template>
    <v-card>
        <v-card-title primary-title class="teal lighten-5">
            <h3 class="display-1 font-weight-light zalfa-text-title">DEBIT MEMO </h3>
        </v-card-title>
        <v-card-text>
            <v-layout row wrap>
                <v-flex xs6 pr-4>
                    <v-layout row wrap>
                        ...
                        <v-flex xs12>
                            ...
                            <v-text-field
                                ...
                                readonly
                                :clearable="memo_id==0"
                                @click:clear="selected_vendor=null"
                                v-show="!!selected_vendor"
                            ></v-text-field>
                        </v-flex>
                    </v-layout>
...
module.exports = {
    ...
    computed : {
        ...
        selected_vendor : {
            get () { return this.state.selected_vendor },
            set (v) { this.setObject("selected_vendor", v) }
        },
    ...
    mounted () {
        ...
        this.$store.dispatch('memoNew/search_account').then((y) => {
            this.$store.dispatch('memoNew/search_vendor').then((x) => {
