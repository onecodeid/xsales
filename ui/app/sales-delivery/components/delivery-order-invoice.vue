...
module.exports = {
    computed : {
        dialog : {
            get () { return this.$store.state.delivery.dialog_invoice },
            set (v) { this.$store.commit('delivery/set_common', ['dialog_invoice', v]) }
        },

        order_date () {
            return this.$store.state.delivery.selected_delivery.delivery_date
        },

        order_number () {
            return this.$store.state.delivery.selected_delivery.delivery_number
        },
    ...
    methods : {
        save () {
            return this.$store.dispatch('delivery/invoice')
        }
    }
}
</script>