    ...
    >
        <v-card>
            <v-card-title primary-title class="cyan white--text pt-3">
                <h3>
                    <span v-show="!edit">PENNGELUARAN UANG MUKA</span>
                                ...
                                <v-layout row wrap>
                                    ...
                                    <!-- <v-flex xs6>
                                        <v-autocomplete
                                            ...
                                            label="Bank Giro"
                                            :disabled="false"
                                            v-if="dialog&&selected_paymenttype&&selected_paymenttype.paymenttype_code=='PAY.BG'"
                                            placeholder="Pilih salah satu"
                                            clearable
                                        ></v-autocomplete>
                                    </v-flex>
...
module.exports = {
    ...
    computed : {
        ...
        btn_save_enabled () {
            ...
            if (!this.selected_vendor||!this.selected_account||parseFloat(this.dp_amount)==0)
                return false
        ...
        vendors () {
            return this.$store.state.dp_new.vendors
        },

        selected_vendor : {
            get () { return this.$store.state.dp_new.selected_vendor },
            set (v) { 
    ...
    mounted () {
        this.$store.dispatch('dp_new/search_vendor')
