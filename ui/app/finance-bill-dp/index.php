         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <common-navbar></common-navbar>
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <finance-bill-dp-list></finance-bill-dp-list>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
            ...
            <finance-bill-dp-new></finance-bill-dp-new>
...
methods : {
   ...
   components: {
        ...
        "finance-bill-dp-list" : httpVueLoader("./components/finance-bill-dp-list.vue"),
        "finance-bill-dp-new" : httpVueLoader("./components/finance-bill-dp-new.vue"),
