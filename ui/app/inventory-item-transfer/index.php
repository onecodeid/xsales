         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <common-navbar></common-navbar>
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <iv-item-transfer-list></iv-item-transfer-list>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
            ...
            <iv-item-transfer-new></iv-item-transfer-new>
            <iv-item-transfer-item-list></iv-item-transfer-item-list>
         </v-app>
      </div>
...
methods : {
   ...
   components: {
        ...
        "iv-item-transfer-list" : httpVueLoader("./components/iv-item-transfer-list.vue<?php echo $ts ?>"),
        "iv-item-transfer-new" : httpVueLoader("./components/iv-item-transfer-new.vue<?php echo $ts ?>"),
        "iv-item-transfer-item-list" : httpVueLoader("./components/iv-item-transfer-item-list.vue<?php echo $ts ?>")
      }
    })
    </script>
    <style>
