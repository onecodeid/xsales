...
module.exports = {
    components : {
        ...
        'detail-add' : httpVueLoader('./finance-cash-detail-add.vue?t='+rnd)
    },
    ...
    computed : {
        payment_date : {
            get () { return this.$store.state.cashNew.cash_date },
            set (v) { this.setObject('cash_date', v) }
        },
        // payment_date () {
