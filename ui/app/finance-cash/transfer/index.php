         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <!-- <common-notification></common-notification> -->
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <finance-cash-transfer-new></finance-cash-transfer-new>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
...
mounted: function() {
    ...
    this.$store.commit("cashNew/set_object", ["cash_type_code", "CASH.TRANSFER"])
...
methods : {
   ...
   components: {
        ...
        "finance-cash-transfer-new" : httpVueLoader("../components/finance-cash-transfer-new.vue")
      }
    })
    </script>
    <style>
