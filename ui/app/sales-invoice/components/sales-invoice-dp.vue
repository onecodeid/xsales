                ...
                <v-layout row wrap>
                    <v-flex xs12 v-for="(idp, n) in invoice_dps" :key="n">
                        ...
                        <v-layout row wrap v-show="!!idp.dp">
                            ...
                            <v-flex xs1>
                                <v-btn color="red" class="ma-0 mr-1" icon :dark="false" flat @click="del_detail(n)" :disabled="selected_invoice.invoice_paid>0"><v-icon>delete</v-icon></v-btn>
                            </v-flex>
                        </v-layout>
                    ...
                    <v-flex xs12 class="text-xs-center">
                        <v-btn color="primary btn-icon" @click="add_detail" :disabled="selected_invoice.invoice_paid>0"><v-icon>add</v-icon></v-btn>
                    </v-flex>        
                </v-layout>
            </v-flex>
        </v-layout>
