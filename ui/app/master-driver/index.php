         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <!-- <common-notification></common-notification> -->
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <master-driver-list></master-driver-list>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
            ...
            <master-driver-new></master-driver-new>
         </v-app>
      </div>
...
methods : {
   ...
   components: {
        ...
        "master-driver-list" : httpVueLoader("./components/master-driver-list.vue"),
        "master-driver-new" : httpVueLoader("./components/master-driver-new.vue")
      }
    })
    </script>
    <style>
