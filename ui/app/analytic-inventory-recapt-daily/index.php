         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <common-navbar></common-navbar>
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <an-inventory-recapt-daily-list></an-inventory-recapt-daily-list>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
...
mounted: function() {
    if (!this.$store.state.system.one_token)
      ...
      this.$store.dispatch('inventory/search_warehouse')    
...
methods : {
   ...
   components: {
        ...
        "an-inventory-recapt-daily-list" : httpVueLoader("./components/an-inventory-recapt-daily-list.vue")
      }
    })
    </script>
    <style>
