                ...
                <v-flex xs2 class="text-xs-right" pl-2>
                    ...
                    >
                        <template v-slot:append-outer>
                            ...
                            <v-btn color="success" class="ma-0 btn-icon ml-1" @click="add" disabled>
                                <v-icon>add</v-icon>
                            </v-btn>
                        </template>
                    </v-text-field>
                ...
                <template slot="items" slot-scope="props">
                    <tr :class="is_selected(props.item)?'cyan lighten-4':''">
                        ...
                        <td class="text-xs-center pa-0" @click="select(props.item)">
                            ...
                            <v-btn color="red" class="btn-icon ma-0" small title="Hapus transaksi" @click="del(props.item)" dark :dark="!view">
...
module.exports = {
    ...
    computed : {
        ...
        xtotal_page () {
            return this.$store.state.general.total_journal_page
        },
        ...
        title() {
            return "JURNAL IMPORT DARI JURNAL.ID"
        },
