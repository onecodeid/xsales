   ...
   <body>
      <div v-cloak id="app">
         <v-app id="oneApp"  v-if="one_token">
            ...
            <purchase-order-new></purchase-order-new>
...
methods : {
   ...
   components: {
        ...
        "purchase-order-list" : httpVueLoader("./components/purchase-order-list.vue?t=<?=date('YmdHis');?>"),
        "purchase-order-new" : httpVueLoader("./components/purchase-order-new.vue?t=<?=date('YmdHis');?>"),
