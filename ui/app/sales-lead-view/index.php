         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <common-navbar></common-navbar>
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <sales-lead-list></sales-lead-list>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
...
methods : {
   ...
   components: {
        ...
        "sales-lead-list" : httpVueLoader("../sales-lead/components/sales-lead-list.vue?t=<?=date('YmdHis');?>"),
        "sales-lead-new" : httpVueLoader("../sales-lead/components/sales-lead-new.vue?t=<?=date('YmdHis');?>")
      }
    })
    </script>
    <style>
