    ...
    actions: {
        ...
        async searchAnalytic(context) {
            ...
            context.dispatch("system/postme", {
                url: "report/one_iv_011/search_analytic",
                prm: prm,
                callback: function(d) {
        ...
        async saveAnalytic(context) {
            let prm = {
                token: one_token(),
                attr1: context.state.selected_warehouse ? context.state.selected_warehouse.warehouse_id : 0,
                desc: JSON.stringify(context.state.analysis)
            }

            return context.dispatch("system/postme", {
                url: "report/one_iv_011/save_analytic",
                prm: prm,
                callback: function(d) {
                    return d
                }
