...
module.exports = {
    ...
    computed : {
        items () {
            return this.$store.state.purchase005.items
        },
        ...
        bill_id () {
            return this.$store.state.purchase005.selected_purchase005.M_JournalID
        },

        query : {
            get () { return this.$store.state.purchase005.search },
            set (v) { this.$store.commit('purchase005/update_search', v) }
        },

        query : {
            get () { return this.$store.state.purchase005.search },
            set (v) { this.$store.commit('purchase005/set_object', ['search', v]) }
        },

        curr_page : {
            get () { return this.$store.state.purchase005.current_page },
            set (v) { this.$store.commit('purchase005/set_object', ['current_page', v]) }
        },

        xtotal_page () {
            return this.$store.state.purchase005.total_item_page
        },

        text_post () {
            let j = this.$store.state.purchase005.selected_item
            return "Apakah anda yakin akan melakukan Posting Jurnal tersebut ?"
        },

        s_date : {
            get () { return this.$store.state.purchase005.s_date },
            set (v) { this.$store.commit('purchase005/set_common', ['s_date', v]) }
        },

        e_date : {
            get () { return this.$store.state.purchase005.e_date },
            set (v) { this.$store.commit('purchase005/set_common', ['e_date', v]) }
        },
        ...
        categories () {
            return this.$store.state.purchase005.categories
        },

        selected_category : {
            get () { return this.$store.state.purchase005.selected_category },
            set (v) { 
                this.$store.commit('purchase005/set_object', ['selected_category', v]) 
                this.search()
            }
        },
        ...
        selected_staff : {
            get () { return this.$store.state.purchase005.selected_staff },
            set (v) { 
                this.$store.commit('purchase005/set_object', ['selected_staff', v]) 
                this.search()
            }
        }
    },
    ...
    methods : {
        ...
        confirm_del (x) {
            this.$store.dispatch('purchase005/del', {id:x.data})
        },
        ...
        confirm_post (x) {
            this.$store.dispatch('purchase005/post', {id:x.data})
        },

        select (x) {
            this.$store.commit('purchase005/set_object', ['selected_item', x])
        },

        search () {
            return this.$store.dispatch('purchase005/search', {})
        },

        change_page(x) {
            this.curr_page = x
            this.$store.dispatch('purchase005/search', {})
        },

        change_s_date(x) {
            this.$store.commit('purchase005/set_common', ['s_date', x.new_date])
            this.$store.dispatch('purchase005/search')
        },

        change_e_date(x) {
            this.$store.commit('purchase005/set_common', ['e_date', x.new_date])
            this.$store.dispatch('purchase005/search')
        },
        ...
        print_invoice (x) {
            this.select(x)
            let so = x
            this.report_url = this.$store.state.purchase005.URL+"report/one_purchase_002?id="+so.bill_id
        ...
        detail (x, y) {
            ...
            let sc = y
            this.$store.commit('purchase005/set_object', ['selected_item', sc])
            // this.$store.commit('bill_new/set_common', ['edit', true])
            ...
            // let scv = this.$store.state.purchase005.selected_item
            ...
            // this.$store.commit('bill_new/set_common', ['dialog_new', true])
            this.$store.commit('purchase005/set_object', ['dialog_detail', true])
        },

        printMe () {
            this.$store.dispatch("purchase005/collect").then((x) => {
                window.open(this.$store.state.purchase005.URL + 'report/one_purchase_005/excel?' + x)
            })
        }
    },
    ...
    mounted () {
        ...
        this.$store.dispatch('purchase005/search')
        this.$store.dispatch('purchase005/search_category')
