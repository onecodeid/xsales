        ...
        <v-card>
            ...
            <v-card-text>
                <v-layout row wrap>
                    ...
                    <v-flex xs12>
                        <common-datepicker label="Tanggal Stok" data="1" :solo="false" @change="change_sdate" :date="sdate"></common-datepicker>
                    </v-flex>
                </v-layout>
            </v-card-text>
...
module.exports = {
    ...
    computed : {
        ...
        params () {
            return ['warehouseid='+this.selected_warehouse.warehouse_id,'date='+this.sdate].join('&')
        },
