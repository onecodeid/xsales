...
methods : {
   ...
   components: {
        ...
        "report-list" : httpVueLoader("../components/report-list.vue?t=<?=date('YmdHis')?>"),
        "common-dialog-print" : httpVueLoader("../../common/components/common-dialog-print-2.vue?t=<?=date('YmdHis');?>"),
