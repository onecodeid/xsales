         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <common-navbar></common-navbar>
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <finance-payment-dp-list></finance-payment-dp-list>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
            ...
            <finance-payment-dp-new></finance-payment-dp-new>
...
methods : {
   ...
   components: {
        ...
        "finance-payment-dp-list" : httpVueLoader("./components/finance-payment-dp-list.vue?t=<?=$ts;?>"),
        "finance-payment-dp-new" : httpVueLoader("./components/finance-payment-dp-new.vue?t=<?=$ts;?>"),
        "trans-journal-view" : httpVueLoader("../trans-journal/components/trans-journal-new.vue?abcde")
      }
    })
    </script>
    <style>
