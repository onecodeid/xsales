        ...
        <v-card-text class="pt-2">
            <v-data-table 
                ...
                <template slot="items" slot-scope="props">
                    ...
                    <td class="text-xs-left pa-1" @click="select(props.item)" v-show="!is_sales">
...
module.exports = {
    ...
    computed : {
        ...
        selected_account : {
            get () { return this.$store.state.dp.selected_account },
            set (v) { 
                this.$store.commit('dp/set_selected_account', v)
                this.search()
            }
        }
    },
    ...
    methods : {
        ...
        add () {
            ...
            this.$store.commit('dp_new/set_selected_customer', null)
        ...
        edit (x) {
            ...
            for (let v of this.$store.state.dp_new.customers)
                if (v.customer_id == x.customer_id)
