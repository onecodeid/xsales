                    ...
                    <v-flex xs12>
                        <v-layout row wrap>
                            <v-flex md8 sm6 xs12 pt-2>
                                ...
                                {{selected_tab.id==1?'SYSTEM SETTINGS':'TARGET OMZET PER CUSTOMER LEVEL'}}
                            </h3>
                            </v-flex>
                     ...
                     <v-flex xs12>
                        <system-setting v-if="selected_tab.id == 1"></system-setting>
...
methods : {
   ...
   components: {
        ...
        "system-setting" : httpVueLoader("./components/system-setting.vue"),
        "customer-omzet-setting" : httpVueLoader("../finance-target-omzet/components/finance-target-omzet-list.vue")
      }
    })
    </script>
    <style>
