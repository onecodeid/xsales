         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <!-- <common-notification></common-notification> -->
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <master-affiliate-list></master-affiliate-list>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
            ...
            <master-affiliate-new></master-affiliate-new>
         </v-app>
      </div>
...
methods : {
   ...
   components: {
        ...
        "master-affiliate-list" : httpVueLoader("./components/master-affiliate-list.vue"),
        "master-affiliate-new" : httpVueLoader("./components/master-affiliate-new.vue")
      }
    })
    </script>
    <style>
