...
export default {
    ...
    actions: {
        ...
        //             context.commit("update_payments", data.records)
        //             context.commit("update_total_payment", data.total)
        //             context.commit("update_total_payment_page", data.total_page)
        //         }
        //     } catch (e) {
        //         context.commit("update_search_status", 3)
        ...
        async del(context) {
            let prm = {
                payment_id : context.state.selected_payment.payment_id
            }

            context.dispatch("system/postme", {
                url:"sales/payment/delete",
                prm:prm,
                callback:function(d) {
