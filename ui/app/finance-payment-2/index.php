         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <common-navbar></common-navbar>
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <finance-payment-invoice-list></finance-payment-invoice-list>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
            ...
            <finance-payment-new></finance-payment-new>
            <!-- <finance-payment-proforma></finance-payment-proforma> -->
...
methods : {
   ...
   components: {
        ...
        "finance-payment-invoice-list" : httpVueLoader("./components/finance-payment-invoice-list.vue?t=<?=date('YmdHis')?>"),
        "finance-payment-new" : httpVueLoader("./components/finance-payment-new.vue?t=<?=date('YmdHis')?>"),
      //   "finance-payment-proforma" : httpVueLoader("./components/finance-payment-proforma.vue?t=<?=date('YmdHis')?>"),
