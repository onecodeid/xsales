         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <!-- <common-notification></common-notification> -->
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <master-disc-list></master-disc-list>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
            ...
            <master-disc-new></master-disc-new>
         </v-app>
      </div>
...
methods : {
   ...
   components: {
        ...
        "master-disc-list" : httpVueLoader("./components/master-disc-list.vue"),
        "master-disc-new" : httpVueLoader("./components/master-disc-new.vue")
      }
    })
    </script>
    <style>
