   ...
   <body>
      <div v-cloak id="app">
         <v-app id="oneApp"  v-if="one_token">
            ...
            <v-footer class="mb-5 footer" app color="financeparent">
                <v-spacer></v-spacer>
...
methods : {
   ...
   components: {
        ...
        "finance-payment-list" : httpVueLoader("./components/finance-payment-list.vue"),
        "finance-payment-new" : httpVueLoader("./components/finance-payment-new.vue")
      }
    })
    </script>
    <style>
