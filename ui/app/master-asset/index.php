         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <common-navbar></common-navbar>
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <master-asset-list></master-asset-list>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
            ...
            <master-asset-new></master-asset-new>
         </v-app>
      </div>
...
methods : {
   ...
   components: {
        ...
        "master-asset-list" : httpVueLoader("./components/master-asset-list.vue"),
        "master-asset-new" : httpVueLoader("./components/master-asset-new.vue")
      }
    })
    </script>
    <style>
