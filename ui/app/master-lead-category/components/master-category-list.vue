        ...
        <v-card-text class="pt-2">
            <v-data-table 
                ...
                <template slot="items" slot-scope="props">
                    <td class="text-xs-left pa-2" @click="select(props.item)">{{ props.item.category_acronym }}</td>
...
module.exports = {
    ...
    methods : {
        ...
        add () {
            ...
            this.$store.commit('category_new/set_common', ['category_acronym', ''])
        ...
        edit (x) {
            ...
            this.$store.commit('category_new/set_common', ['category_acronym', sc.category_acronym])
            this.$store.commit('category_new/set_dialog_new', true)
        },
