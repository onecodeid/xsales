                ...
                <v-layout row wrap>
                    <v-flex xs12>
                        <v-layout row wrap>
                            ...
                            <v-flex xs12 :class="`mt-`+v_space">
                                <v-text-field
                                    label="Akronim Category"
                                    v-model="category_acronym"
                                ></v-text-field>
                            </v-flex>
...
module.exports = {
    ...
    computed : {
        ...
        category_acronym : {
            get () { return this.$store.state.category_new.category_acronym },
            set (v) { this.$store.commit('category_new/set_common', ['category_acronym', v]) }
        },
