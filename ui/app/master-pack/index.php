         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <!-- <common-notification></common-notification> -->
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <master-pack-list></master-pack-list>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
...
methods : {
   ...
   components: {
        ...
        "master-pack-list" : httpVueLoader("./components/master-pack-list.vue?d=<?= date('YmdHis'); ?>"),
        "master-pack-new" : httpVueLoader("./components/master-pack-new.vue?d=<?= date('YmdHis'); ?>")
      }
    })
    </script>
    <style>
