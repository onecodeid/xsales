         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <!-- <common-notification></common-notification> -->
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <master-expedition-list></master-expedition-list>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
...
methods : {
   ...
   components: {
        ...
        "master-expedition-list" : httpVueLoader("./components/master-expedition-list.vue"),
        "master-expedition-new" : httpVueLoader("./components/master-expedition-new.vue")
      }
    })
    </script>
    <style>
