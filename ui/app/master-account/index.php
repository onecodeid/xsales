   ...
   <body>
      <div v-cloak id="app">
         <v-app id="oneApp"  v-if="one_token">
            ...
            <master-account-new></master-account-new>
            <master-account-balance></master-account-balance>
         </v-app>
      </div>
...
methods : {
   ...
   components: {
        ...
        "master-account-list" : httpVueLoader("./components/master-account-list.vue?t=<?=date('YmdHis');?>"),
        "master-account-new" : httpVueLoader("./components/master-account-new-2.vue<?php echo $ts ?>"),
        "master-account-balance" : httpVueLoader("./components/master-account-balance-2.vue")
      }
    })
    </script>
    <style>
