   ...
   <body>
      <div v-cloak id="app">
         <v-app id="oneApp"  v-if="one_token">
            ...
            <master-item-stock></master-item-stock>
...
methods : {
   ...
   components: {
        ...
        "master-item-list" : httpVueLoader("../master-item/components/master-item-list.vue?t=<?=date('YmdHis')?>"),
        "master-item-new" : httpVueLoader("../master-item/components/master-item-new.vue?t=<?=date('YmdHis')?>"),
        "master-item-alias" : httpVueLoader("../master-item/components/master-item-alias.vue"),
        "master-item-stock" : httpVueLoader("../master-item/components/master-item-stock.vue"),
        "master-item-stock-card" : httpVueLoader("../master-item/components/master-item-stock-card-print.vue"),
        ...
        "master-category-new" : httpVueLoader("../master-category/components/master-category-new.vue")
      }
    })
    </script>
    <style>
