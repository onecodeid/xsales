               ...
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        ...
                        <finance-payable-list></finance-payable-list>
                        <finance-payable-pay-dialog></finance-payable-pay-dialog>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
...
methods : {
   ...
   components: {
        ...
        "finance-payable-list" : httpVueLoader("../components/finance-payable-list.vue<?php echo $ts ?>"),
        "finance-payable-pay-dialog" : httpVueLoader("../components/finance-payable-pay-dialog.vue<?= $ts; ?>")
      }
    })
    </script>
    <style>
