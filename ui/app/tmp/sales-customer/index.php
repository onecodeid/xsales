         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <!-- <common-notification></common-notification> -->
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <sales-customer-list></sales-customer-list>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
...
mounted: function() {
    ...
    this.$store.dispatch('salesCustomer/search_customer')
},
computed : {
    one_token () {
...
methods : {
   ...
   components: {
        ...
        "sales-customer-list" : httpVueLoader("../components/sales-customer-list.vue")
      }
    })
    </script>
    <style>
