...
module.exports = {
    ...
    computed : {
        ...
        banks () {
            return this.$store.state.vendor_new.banks
        },

        cbanks () {
            return this.$store.state.vendor_new.cbanks
        },
    ...
    methods : {
        add_cbank () {
            let x = this.cbanks
            x.push(JSON.parse(JSON.stringify(this.$store.state.vendor_new.template_cbank)))

            this.$store.commit('vendor_new/set_cbanks', x)
        },
