         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <!-- <common-notification></common-notification> -->
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <finance-bill-list></finance-bill-list>
                        <finance-bill-new></finance-bill-new>
                        <finance-bill-pay-dialog></finance-bill-pay-dialog>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
...
methods : {
   ...
   components: {
        ...
        "finance-bill-list" : httpVueLoader("../components/finance-bill-due-list.vue<?php echo $ts ?>"),
        "finance-bill-new" : httpVueLoader("../components/finance-bill-new.vue<?php echo $ts ?>"),
        "finance-bill-pay-dialog" : httpVueLoader("../components/finance-bill-pay-dialog.vue<?= $ts; ?>")
      }
    })
    </script>
    <style>
