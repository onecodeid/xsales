         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <!-- <common-notification></common-notification> -->
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <master-category-list></master-category-list>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
...
methods : {
   ...
   components: {
        ...
        "master-category-list" : httpVueLoader("./components/master-category-list.vue"),
        "master-category-new" : httpVueLoader("./components/master-category-new.vue")
      }
    })
    </script>
    <style>
