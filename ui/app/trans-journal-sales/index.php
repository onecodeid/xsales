   ...
   <body>
      <div v-cloak id="app">
         <v-app id="oneApp"  v-if="one_token">
            ...
            <trans-journal-new></trans-journal-new>
         </v-app>
      </div>
...
methods : {
   ...
   components: {
        ...
        "trans-journal-list" : httpVueLoader("../trans-journal/components/trans-journal-list.vue"),
        "trans-journal-new" : httpVueLoader("../trans-journal/components/trans-journal-new.vue")
      }
    })
    </script>
    <style>
