         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <common-navbar></common-navbar>
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <iv-item-assembly-list></iv-item-assembly-list>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
            ...
            <iv-item-assembly-new></iv-item-assembly-new>
            <iv-item-assembly-item-list></iv-item-assembly-item-list>
         </v-app>
      </div>
...
methods : {
   ...
   components: {
        ...
        "iv-item-assembly-list" : httpVueLoader("./components/iv-item-assembly-list.vue?t=<?=date("YmdHis");?>"),
        "iv-item-assembly-new" : httpVueLoader("./components/iv-item-assembly-new.vue?t=<?=date("YmdHis");?>"),
        "iv-item-assembly-item-list" : httpVueLoader("./components/iv-item-assembly-item-list.vue")
      }
    })
    </script>
    <style>
