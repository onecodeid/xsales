...
module.exports = {
    components : {
        "master-customer-new-address-form" : httpVueLoader("../../master-customer/components/master-customer-new-address-form.vue?t=a1sd")
    },
    ...
    methods : {
        save () {
            ...
            this.$store.dispatch('sales_new/add_address')
        }
    },
