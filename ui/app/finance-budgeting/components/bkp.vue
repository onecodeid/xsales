                ...
                <template slot="items" slot-scope="props">
                    <tr :class="props.item.account_pos=='D'?'cyan':'pink'" class="lighten-5">
                        ...
                        <template v-for="(b, n) in props.item.budgets">
                            <td class="text-xs-left pa-1" :class="{'grey lighten-5':b.date==selected_start_month.label3}" @click="select(props.item)" v-bind:key="'b'+n">
                            ...
                            <td class="text-xs-right pa-1" :class="{'blue-grey lighten-5':b.date==selected_start_month.label3}" @click="select(props.item)" v-bind:key="'a'+n">
                            ...
                            <td class="text-xs-right pa-1 amber lighten-5"  @click="select(props.item)" v-bind:key="'c'+n">
                                <div class="d-flex" v-show="props.item.M_AccountParent!='Y'">
...
module.exports = {
    ...
    methods : {
        __d (x) { return this.$store.dispatch("budgeting/"+x) },
        ...
        select (x) {
            this.$store.commit('budgeting/set_selected_account', x)
        },
